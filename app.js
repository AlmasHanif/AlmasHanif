...
//  var revrse = counting.reverse();
//  document.write(revrse)
...
// var symbols = String.fromCharCode(64);
// var check = true;
...
// var input = prompt("");
// var check = input.charAt(input.length-1);
// alert("usre input "  + input );
// alert("last character of input is " +"...."  + check)


// Q no 18
 
// var text = "The quick brown fox jumps over the lazy dog";
// var count=text.indexOf("fox");
// alert(count)
...
// var a = Math.abs(-4);
// document.write("the value of  -4 is " + a);
...
// alert("the weight of user is "  +  a + " kilograms")


// Q no 8

// var user = prompt("enter a value between 1 to 10");
...
// var now = new Date();
// var theDay = now.getDay();
// if(theDay === dayNames[0,6]){
//     alert("its funday")
// }
// else{
//     alert("its not a funday")
// }
...
// var miliSec = old.getMilliseconds();
// var a = current - oldTime;
// var minute = old.getMinutes();
// var b = (old/(1000*3600))
// document.write( "Current date " + current + "<br>" + "Elpased milisecond since january 1 : 1970 " + a +"<br>" + "Elpased minute since january 1 : 1970 " + b)
...
// var date1 = new Date();
// var date2 = new Date("18 june 2015");
// var a = date1 - date2;
// // var b = Math.round(a/(1000*60*60*24));
// alert(b + " Days have passed since 1st Ramdan 2015");
...
// var date1 = new Date();
// var date2 = new Date("5 dec 2015");
// var a = date1 - date2;
// var b = Math.floor(a/1000);
// document.write("on refrence date " + date1 + "<br>" + b + "seconds has passed since begining of 2015 " )
...
// var date2 = new Date();
//  date2.setHours(1);
// document.write("Current date is " + date1 + "<br>"  + "1 hour ago , it was " + date2);
...
//   document.write("Current date is " + date1 + "<br>"  + "100 year back , it was " + date2);
...
// document.write("your age is " + age +  "<br>" +  "Birth year is "  + birthYear)


// Q no 14


// var username = "ABC Coustemer";
// var months = ["jan" , "feb" , "mar" , "apr" , "may" , "jun" , "jul" , "aug" , "sep" , "oct" , "nov" , "dec"];
// var date = new Date();
// var billMonth = date.getMonth();
// months = months[1];
// var unit = 410;
// var unitCharges = 16;
// var payment = unit*unitCharges;
// var lateCharges = 350;
// var duepayment = payment+lateCharges;

// document.write("<h1> K - Electric Bill </h1>")
// document.write("Coustemer name : " + username + "<br>");
// document.write("Month : " + months + "<br>");
// document.write("Number of units ; " + unit + "<br>");
// document.write("Charges pre unit : " + unitCharges + "<br>" + "<br>" );
// document.write("Net amount payment (within due date) " +  payment  + "<br>");
// document.write("Late payment surcharge " + lateCharges + "<br>");
// document.write("Gross amount payment (after due date) " + duepayment + "<br>")
